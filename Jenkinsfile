...
node {
   ...
   catchError {
	   ...
	   stage('Preparation') {
	      ...
	      dir('gemoc-studio-execution-java') {
	         def gemocstudiomexecJavaScm = resolveScm source: [$class: 'GitSCMSource', credentialsId: '', id: '_', remote: 'https://github.com/gemoc/gemoc-studio-execution-java.git', traits: [[$class: 'BranchDiscoveryTrait']]], targets: [BRANCH_NAME, 'master']
	         checkout gemocstudiomexecJavaScm
	      }
	      dir('gemoc-studio-execution-ale') {
	         def gemocstudioexecutionaleScm = resolveScm source: [$class: 'GitSCMSource', credentialsId: '', id: '_', remote: 'https://github.com/gemoc/gemoc-studio-execution-ale-eclipsefork.git', traits: [[$class: 'BranchDiscoveryTrait']]], targets: [BRANCH_NAME, 'master']

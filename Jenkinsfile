   ...
   catchError {
	   ...
	   stage('Preparation') {
	      ...
	      dir('gemoc-studio-execution-moccml') {
	         def gemocstudioexecutionmoccmlScm = resolveScm source: [$class: 'GitSCMSource', credentialsId: '', id: '_', remote: 'https://github.com/gemoc/gemoc-studio-execution-moccml', traits: [[$class: 'BranchDiscoveryTrait']]], targets: [BRANCH_NAME, 'master']
